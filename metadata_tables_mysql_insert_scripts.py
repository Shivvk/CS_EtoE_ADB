...
# tbl_source
spark.sql(f"""
insert into metadata_schema.tbl_source_control values ('mysql_host',102,'localhost',NULL,3306,'fmcg','root','mysql-password','{storage_account}','{adls_url}','landing','{logic_app_url}','{email_id}')        
""")
